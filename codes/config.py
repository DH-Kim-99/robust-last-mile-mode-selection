...
class ProblemConfig:
    ...
    def __init__(self, instance_type='full'):
        ...
        if instance_type == 'toy':
            ...
            self.K = 3    # Products
            self.I = 3    # Plants per product
            self.J = 5    # DCs
            self.R = 200  # Customers
            self.M = 3    # Transport modes
            self.grid_size = 100  # Coordinate grid size
        else:
        ...
        # Data file paths
        import os as _os
        self.data_file = _os.path.join(_os.path.dirname(_os.path.abspath(__file__)), '..', 'data', f"data_{instance_type}.pkl")
        self.results_dir = _os.path.join(_os.path.dirname(_os.path.abspath(__file__)), '..', 'result')
...
class SensitivityConfig:
    ...
    def __init__(self, R):
        ...
        self.output_file = _os.path.join(_os.path.dirname(_os.path.abspath(__file__)), '..', 'result', 'sensitivity_results.csv')
        self.plot_file = _os.path.join(_os.path.dirname(_os.path.abspath(__file__)), '..', 'result', 'sensitivity_plot.png')
